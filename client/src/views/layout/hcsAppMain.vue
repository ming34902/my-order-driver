  ...
  <div class="app-wrapper" :class="{hideSidebar:!sidebar.opened}">
    ...
    <div class="main-container">
      <div class="main-container-box">
        <tabs-view class="hcs-tabs-view" style="height: 40px"></tabs-view>
        <app-main class="hcs-app-main"></app-main>
        <el-footer class="hsc-footer" tyle="height: 40px">
          &copy; 2012-2016&nbsp; 中联物流（中国）有限公司&nbsp; 赣ICP备13001118号 - 2
        </el-footer>
      </div>
    </div>
  </div>
...
<script>
  ...
  import { Sidebar, AppMain, Logout, TopNav, TabsView } from '@/views/layout'
